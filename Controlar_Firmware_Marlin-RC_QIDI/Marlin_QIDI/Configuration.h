...
#define STRING_CONFIG_H_AUTHOR "(Samiul, default config)" // Who made the changes.
#define STRING_VERSION_CONFIG_H __DATE__ " " __TIME__
#define SHOW_BOOTSCREEN 
#define STRING_SPLASH_LINE1 "LastBuild:" __DATE__   // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Build by samiul"       // will be shown during bootup in line 2
...
// Optional custom name for your custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "Multi-Material 3d Pri."
...
//#define HOTEND_OFFSET_X {0, 33.992} // (in mm) for each extruder, offset of the hotend on the X axis
//#define HOTEND_OFFSET_Y {0, 0.096}  // (in mm) for each extruder, offset of the hotend on the Y axis
 ...
 * Override with M92
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 94.117647, 94.117647, 400, 96.2752 }  
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 94.117647, 94.117647, 400, 3200 }  
...
#define DEFAULT_MAX_FEEDRATE          { 2500, 2500, 1100, 1000 }
/**
...
#define DEFAULT_MAX_ACCELERATION      { 1800, 1800, 1170, 1000 }
/**
